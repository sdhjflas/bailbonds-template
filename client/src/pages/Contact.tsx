 ...
 * CONTENT: Actual data from Bail America Liberty Contact Us page
 */
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            >
              ...
              <p className="font-body text-[#0D0D0D]/70 mb-6 leading-relaxed">
                Bail America Bail Bonds located in Liberty, Texas, serves all jails in Liberty County, Texas including:
              </p>
              ...
              >
                <p className="font-body text-[#0D0D0D]/70 leading-relaxed">
                  <span className="font-semibold text-[#0D0D0D]">Mobile Bonds Available:</span> We come to you! Our mobile bonding service brings the convenience of bail bonding directly to you.
                </p>
              </motion.div>
            </motion.div>
          </div>
        ...
        <div className="container">
          ...
          >
            ...
            <p className="font-body text-lg text-[#0D0D0D]/70 mb-8 leading-relaxed">
              Bonding someone out of jail can be frustrating. That is why one of our professional Liberty bondsmen will be there to walk you through the entire bail bonds process.
            </p>
            <a
              href="tel:+19363341110"
